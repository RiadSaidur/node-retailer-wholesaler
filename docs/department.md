...
```json
POST http://localhost:5000/department?deptId=62d8ec4b5a6a9796df29a8c8 HTTP/1.1
content-type: multipart/form-data
...
```json
GET http://localhost:5000/department HTTP/1.1
```
...
GET http://localhost:5000/department?_id=62d8ec4b5a6a9796df29a8c8 HTTP/1.1
```
...
// accpeted parameteres: ?_id=, ?dept_name=, ?active=, ?tax_stage=, ?shop=, ?createdAt=
// parameteres can be chained
GET http://localhost:5000/department?shop=62d91ec42a7257d528126ed7 HTTP/1.1
```
...
// accpeted parameteres: ?_id=, ?dept_name=, ?active=, ?tax_stage=, ?shop=, ?createdAt=
// parameteres can be chained
GET http://localhost:5000/department?tax_stage=1st&active=true HTTP/1.1
```
...
```json
DELETE http://localhost:5000/department?deptId=62d8ec4b5a6a9796df29a8c8 HTTP/1.1
```
