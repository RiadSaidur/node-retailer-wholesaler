...
```json
POST http://localhost:5000/sale/pos?pid=630ddbc3fcb3cfb7e8f320ed HTTP/1.1
...
### Sample Request Format for Create Sale
```json
POST http://localhost:5000/sale?cid=630c8925c9d233febec5b80f HTTP/1.1
content-type: application/json
...
GET http://localhost:5000/sale?sort=DESC&days=1&startDate=2022-07-25 HTTP/1.1
```
