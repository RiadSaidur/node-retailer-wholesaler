...
```json
POST http://localhost:5000/pos HTTP/1.1
...
```json
GET http://localhost:5000/pos?posId=62e7657469be529f5bfc0eab HTTP/1.1
```
...
```json
PUT http://localhost:5000/pos?posId=62ebb71920a179cb7206cc27 HTTP/1.1
content-type: application/json
...
```json
DELETE http://localhost:5000/pos?posId=62e955be1b2ec15131c0fbb4 HTTP/1.1
```
...
```json
GET http://localhost:5000/pos/document?posId=6304c33eddde0a670e4c9a99 HTTP/1.1
```
