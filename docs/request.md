...
```json
GET http://localhost:5000/request HTTP/1.1
```
...
POST http://localhost:5000/request?shopId=62c50c2a2f9edf419eeee4c2 HTTP/1.1
...
POST http://localhost:5000/request?rid=62f76a22aeb9e27c9262e950 HTTP/1.1
